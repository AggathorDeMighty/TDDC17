...
public class QLearningController extends Controller {
	 ...
	 * Our defined actions. 
	*/
	private final static int NONE_ENGINE = 0;
	private final static int RIGHT_ENGINE = 1;
	private final static int MIDDLE_ENGINE = 2;
	private final static int LEFT_ENGINE = 3;
	
	private final static int RIGHT_MIDDLE_ENGINE = 4;
	private final static int LEFT_MIDDLE_ENGINE = 5;
	private final static int ALL_ENGINE = 6;
